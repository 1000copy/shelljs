...
========
 ...
 Yargs is the official successor to optimist.With yargs, the options be just a hash!
...
console.log(argv.s,argv.fr ,argv.p )
````
...
Position arg(non-hyphenated options),Just use `argv._`!
-------------------------------------------------
...
Tell users how to use  options and make demands.
-------------------------------------------------
...
After demands have been met, demand more! Ask for position arguments!
-----------------------------------------
...
You can describe parameters fer help messages and set aliases. 
